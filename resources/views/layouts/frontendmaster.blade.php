                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-3">
                            <div class="allcategories_dropdown">
                                <button class="allcategories_btn" type="button" data-bs-toggle="collapse" data-bs-target="#allcategories_collapse" aria-expanded="false" aria-controls="allcategories_collapse" onClick="display()">
                                ...
                                <div class="allcategories_collapse" id="allcategories_collapse">
                                    <div class="card card-body">
                                        ...
                                        @else
                                            <ul class="allcategories_list ul_li_block" style="display: none" id="demo">
                                                <li><a href="shop_grid.html"><i class="icon icon-Starship"></i> New Arrival Products</a></li>
                                                <li><a href="shop_list.html"><i class="icon icon-WorldWide"></i> Most Popular Products</a></li>
                                                <li><a href="shop_grid.html"><i class="icon icon-Star"></i> Deals of the day</a></li>
                                                <li><a href="shop_list.html"><i class="icon icon-Phone"></i> Mobile Accessories</a></li>
                        ...
                        <div class="col col-md-4">
                            <ul class="header_icons_group ul_li_right">
                                @guest
                                <li>
                                    <a href="{{ route('account') }}">Login / Register</a>
                                </li>
                                @endguest
...
================================================== -->
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/635ffc30b0d6371309cc828b/1ggnf281q';
            s1.charset='UTF-8';
