                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="col-sm-4 pl-0">
                                <a href="{{ route('send/verfication/code') }}" class="btn btn-primary btn-sm mb-3">Verify Now</a>
                            </div>
                            @endif
                            <form method="POST" action="{{ route('check/code') }}">
                                ...
                                @if (session('code_success'))
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="code" placeholder="Give your code here">
                                            @error('code')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
