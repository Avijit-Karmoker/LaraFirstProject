                                        ...
                                        <div class="category_boxed">
                                            <a href="#!">
                                                <span class="item_image">
                                                    <img style src="{{ asset('uploads/category_photos') }}/{{ $category->category_photo }}" alt="image_not_found">
                                                </span>
                        ...
                        @if ($categories->count() > 0)
                            <div class="widget audio-widget">
                                ...
                                <ul>
                                    @forelse ($categories as $category)
                                        <li>
                                            <a href="{{ url('category') }}/{{ $category->category_slug }}" target="_blank">{{ $category->category_name }}</a>
                                        </li>
                                    @empty
                                        <li>
                                            <strong class="text-danger">No category to show!</strong>
                                        </li>
                                    @endforelse
                                </ul>
                            </div>
